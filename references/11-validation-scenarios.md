...
3. Place/connect a minimal circuit with a known pin mapping using supported calls. Move one component, read back position/rotation, inspect its rendered placement and compare expected units.
